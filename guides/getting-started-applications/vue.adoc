:title: Secure Vue.js app with Keycloak
:summary: Get started with Keycloak integration with Vue.js app
:author: akoserwal
...
image::{guideImages}/vue-auth-flow.png[Vue App Auth Sequence]
...
NOTE: I am passing keycloak instance as prop to the App component. Which can be used to retrive token.
