...
<table class="table table-bordered table-striped">
    ...
    <tr>
        <td>Demo</td>
        <td>Includes WildFly with server overlay and examples. Not recommended in production.</td>
        <td>
...
<table class="table table-bordered table-striped">
    ...
    <tr>
        <td>Examples</td>
        <td>Example applications and providers</td>
        <td>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#saml" aria-controls="saml" role="tab" data-toggle="tab">SAML 2</a></li>
</ul>

<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="oidc">
                ...
                <td>
                    <table class="table-downloads-inner">
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <a onclick="dl('adapter', 'proxy');" href="https://downloads.jboss.org/keycloak/${version.version}/keycloak-proxy-${version.version}.zip" target="_blank">ZIP</a>
                            </td>
                        </tr>
                    </table>
                </td>
