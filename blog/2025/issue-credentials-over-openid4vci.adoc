...
NOTE: At the time of writing this blog, Keycloak's support for OpenID4VCI is still experimental. This guide uses the https://www.keycloak.org/downloads.html[**Keycloak 26.5.0 release**]. The feature is under active development and is expected to be promoted to preview in the future.
...
To learn more about the **Nonce Lifetime** and other realm attributes for OpenID4VCI, please refer to the main https://www.keycloak.org/docs/26.5.0/server_admin/index.html#_oid4vci[Keycloak documentation].
...
* GitHub: Inspect and participate in recent https://github.com/keycloak/keycloak/discussions?discussions_q=is%3Aopen+oid4vci[OpenID4VCI-related GitHub discussions].  
  Review existing https://github.com/keycloak/keycloak/issues?q=is%3Aissue%20state%3Aopen%20label%3Aarea%2Foid4vc[OpenID4VCI-related GitHub issues] and feel free to comment on or upvote them, or create a new issue if you have ideas for enhancements or discover a bug.
...
If you want to explore the latest updates to the OID4VCI feature, you can use the latest https://www.keycloak.org/nightly/[Keycloak nightly release]. However, be aware that the instructions in this blog post may not work with that version.
