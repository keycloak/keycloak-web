...
image::${blogImages}/openid4vci/pre-authorized-code-flow.png[alt="Pre-Authorized Code Flow Diagram", align=center, width=600]
...
Your input will help us improve the OpenID4VCI experience in Keycloak.
