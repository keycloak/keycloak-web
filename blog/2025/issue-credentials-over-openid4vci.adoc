...
NOTE: At the time of writing this blog, Keycloak's support for OpenID4VCI is still experimental. This guide uses the https://www.keycloak.org/nightly/[**nightly release**] which builds from the main branch. The feature is under active development and is expected to be promoted to preview in a future release.
...
| `ES256`
| Defines the credential signing algorithm.
|===
...
|===
| Mapper Type | Mapper Name | Token Claim Name | User Attribute / Source | Claim Display Information
...
If you are looking into streamlining this configuration process for OpenID4VCI in Keycloak, take a look at our https://github.com/keycloak/keycloak-oauth-sig/tree/main/oid4vci-deployment#readme[OID4VCI Deployment] project, which provides solid examples for both the pre-authorization and authorization code flows.
You may also find the https://github.com/keycloak/keycloak-playground/blob/main/fapi-playground/README.md#oid4vci-demo[Keycloak Playground OID4VCI demo] useful as a hands-on demo.
