...
<p>
This is the very first "Keycloak Community Newsletter". The goal of this newsletter is to share the news around the Keycloak project : contributions, technical articles, future plans of the team etc...  
</p>
...
<p>
Ramandeep Singh has been <a href="https://medium.com/@ramandeep.singh.1983/enterprise-web-app-authentication-using-keycloak-and-node-js-c10b0e26b80d">blogging</a> about Keycloak and NodeJS and Joshua Alfred Erney explain in this <a href="https://www.jerney.io/secure-apis-kong-keycloak-1/">blog serie</a> how to integrate Keylcoak and <a href="https://konghq.com/">Kong</a>, a popular API management platform.
</p>
<P>
With Mohamed Aboullaite's blog post you will learn how to <a href="https://aboullaite.me/secure-kibana-keycloak/">secure your Kibana dashboards using Keycloak</a> and finally in <a href=https://beyondthekube.com/identity-management-for-on-prem-clusters/?utm_sq=g0u3m590zf">this 3 parts article</a> installing Keycloak on Kubernetes will have no more secrets for you. 
</p>  
...
We have already 3 documemts open for discussion : 
<ul>
