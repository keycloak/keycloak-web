...
<p>
A lot of news to share in this second edition, so fasten your seatbelt and let's go ! 
</p>
...
<p>
Like any other project, setting up clustering can be somehow complex. Liqiang has shared with us his <a href="https://github.com/fit2anything/keycloak-cluster-setup-and-configuration">setup and configuration tips</a> , thanks again for sharing your knwoledge with the community ! 
</p>
<P>
...
<p>
W-Jax has just published on youtube a talk (in German) <a href="https://t.co/GrBvLr6q5N?amp=1">Secure Spring Applications with Keycloak</a> delivered by Thomas Darimont.
<p>
<p>
