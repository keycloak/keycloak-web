...
<div class="bg-gradient-to-b from-gray-900 to-gray-800 text-white pt-16">
    <div class="container mx-auto px-4 py-6" x-data="{ searchQuery: '' }">
        <!-- Version Selector & Categories -->
        <div class="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
            <!-- Version Selector -->
            <div class="w-full lg:w-auto lg:min-w-32">
                <label class="block text-sm font-medium text-gray-300 mb-2">Version</label>
                <select
                    data-nosnippet
                    aria-label="Version"
                    onchange="location = this.options[this.selectedIndex].value;"
                    class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-primary focus:border-transparent"
                >
