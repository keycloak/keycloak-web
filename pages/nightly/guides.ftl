            ...
            <div>
                <form>
                    <div class="guide-search-wrapper">
                        <input id="guide-search" class="form-control" type="text" placeholder="Search" aria-label="Search" data-pagefind="${links.getRoot()}/pagefind/pagefind.js" data-pagefind-version="nightly">
