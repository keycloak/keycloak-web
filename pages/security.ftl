...
<div class="container mt-5 kc-article">
    ...
    <p>When submitting multiple vulnerability findings, each finding <strong>must</strong> be submitted individually to help our team triage. Every finding <strong>must</strong> contain clear evidence of exploitation; we do not accept reports based on static scanners without a proof-of-concept.</p>
