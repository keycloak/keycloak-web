...
<div class="page-section">
    <div class="container">
        ...
        <p>
            You can <a href="search.html">search</a> for information</a> in the documentation and mailing list
            <a href="search.html">here</a>.
        </p>

        <h3><a href="https://keycloak.discourse.group/">Forum</a></h3>

        <p>
            We have a <a href="https://keycloak.discourse.group/">forum</a> where you can find already answered
            questions, or if your question is not already answered
